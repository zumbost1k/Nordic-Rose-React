                ...
                <section className='second_section'>
                            ...
                            <div className='inf_about_author'>
                                ...
                                <div className='text_about_author'>
                                    ...
                                    <p className='time'>
                                        ...
                                        &nbsp;·&nbsp;
                                        {Math.trunc(data.post.content.replace(/(<([^>]+)>)/ig, '').length / 250)}&nbsp;
                                        min read
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className='second_section_block'>
                        ...
                        <div className='article_section_footer'>
                            ...
                            {data.post.all_tags_list.length !== 0 ? <p className='section_footer_text tags'>Tags: {data.post.all_tags_list.map(tag => {
